...
const CourseForm = ({course,allAuthors,onSave,onChange,saving,errors}) => {
  return (
    <form>
      ...
      <SelectInput name="authorDDL" label="Author" value={course.authorId} defaultOption="Select Author" options={allAuthors} onChange={onChange}/>
      ...
      <input type="submit" className="btn btn-primary" text="Save" onClick={onSave}/>
    <form />
  );
};
